/**
 * GET/POST/PUT/DELETE /api/file-ops
 *
 * Sprint R.83.6 Task 3 — file operations family CRUD over center DB
 * unified_mount_dirs (primary table; lists 8 unified_* file-ops tables in sourceTables).
 *
 * Tables:
...
const TARGET_TABLE = "unified_mount_dirs"
const SOURCE_TABLES = [
  "unified_mount_dirs",
  "unified_buffer_dirs",
  "unified_cd_cabinets",
...
export async function GET(req: NextRequest) {
  const traceId = `r83-6-file-ops-${Date.now()}`
  try {
