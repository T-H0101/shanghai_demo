/**
 * GET/POST/PUT/DELETE /api/volume/storage
 *
 * Sprint R.83.4 Task 5 — storage volume family CRUD over center DB
 * unified_volume_groups (primary table; lists 5 unified_volume_* tables
 * in sourceTables).
 *
...
const TARGET_TABLE = "unified_volume_groups"
const SOURCE_TABLES = [
...
export async function GET(req: NextRequest) {
  const traceId = `rbac-volume-${Date.now()}`
  try {
