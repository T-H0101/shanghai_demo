/**
 * GET/POST/PUT/DELETE /api/evidence-verify
 *
 * Sprint R.83.5 Task 5 — evidence + verify family CRUD over center DB
 * unified_evidence_details (primary table; lists 4 unified_evidence_* /
 * unified_verify_* tables in sourceTables).
 *
...
const TARGET_TABLE = "unified_evidence_details"
const SOURCE_TABLES = [
...
export async function GET(req: NextRequest) {
  const traceId = `rbac-evidence-verify-${Date.now()}`
  try {
