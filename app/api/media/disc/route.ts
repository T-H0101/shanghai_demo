/**
 * GET/POST/PUT/DELETE /api/media/disc
 *
 * Sprint R.83.5 Task 5 — disc print media family CRUD over center DB
 * unified_disc_prints (primary table; lists 3 unified_disc_* tables in sourceTables).
 *
...
const TARGET_TABLE = "unified_disc_prints"
const SOURCE_TABLES = [
  "unified_disc_prints",
...
export async function GET(req: NextRequest) {
  const traceId = `rbac-media-${Date.now()}`
  try {
