/**
 * Sprint R.83.9 Task 3 — 2 CRUD endpoints self-check
 * (final-batch-a + final-batch-b)
 *
 * Exercises GET/POST/PUT/DELETE across 2 new resources.
 *
 * Total checks (≥12):
 *   - 2 endpoints × 6 = 12 happy-path + envelope
 *   - 2 negative-path DELETE (missing params) = 2
 *                                                  = 14
 *
 * Usage:
 *   pnpm exec tsx app/api/__tests__/r83.9-api-test.ts
 */
...
const TEST_RECORD_ID = process.env.TEST_RECORD_ID ?? "test-r83-9-selfcheck-1"
