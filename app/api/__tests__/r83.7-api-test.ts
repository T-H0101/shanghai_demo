/**
 * Sprint R.83.7 Task 3 — 3 CRUD endpoints self-check
 * (import-export + monitor + system-aux)
 *
 ...
 *
 * Usage:
 *   pnpm exec tsx app/api/__tests__/r83.7-api-test.ts
 */
...
const TEST_RECORD_ID = process.env.TEST_RECORD_ID ?? "test-r83-7-selfcheck-1"
