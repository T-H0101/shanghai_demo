/**
 * Sprint R.83.6 Task 3 — 3 CRUD endpoints self-check
 * (system-config + iso + file-ops)
 *
 ...
 *
 * Usage:
 *   pnpm exec tsx app/api/__tests__/r83.6-api-test.ts
 */
...
const TEST_RECORD_ID = process.env.TEST_RECORD_ID ?? "test-r83-6-selfcheck-1"
