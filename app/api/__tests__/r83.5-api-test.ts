/**
 * Sprint R.83.5 Task 5 — 6 CRUD endpoints self-check
 * (data + classification + early-warning + media + evidence-verify + transfer)
 *
 * Exercises GET/POST/PUT/DELETE across 6 new resources.
 *
 * Total checks (≥42):
 *   - 6 endpoints × 6 = 36 happy-path + envelope
 *   - 6 negative-path DELETE (missing params) = 6
 *
 * Usage:
 *   pnpm exec tsx app/api/__tests__/r83.5-api-test.ts
 */
...
const TEST_RECORD_ID = process.env.TEST_RECORD_ID ?? "test-r83-5-selfcheck-1"
