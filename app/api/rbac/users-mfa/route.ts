/**
 * GET/POST/PUT/DELETE /api/rbac/users-mfa
 *
 * Sprint R.83.2 Task 5 — User MFA CRUD over center DB unified_user_mfas.
 *
...
const TARGET_TABLE = "unified_user_mfas"
const SOURCE_TABLES = ["unified_user_mfas"]
...
export async function GET(req: NextRequest) {
  const traceId = `rbac-users-mfa-${Date.now()}`
  try {
