 ...
 *
 * Sprint R.83.7 Task 3 — 监控运维 family CRUD over center DB
 * unified_monitor_paths (primary table; lists 5 unified_* tables in sourceTables).
 *
 * Tables:
 ...
 *   - unified_project_monitor_files (tbl_project_monitor_files)
...
const TARGET_TABLE = "unified_monitor_paths"
const SOURCE_TABLES = [
...
export async function GET(req: NextRequest) {
  const traceId = `r83-7-monitor-${Date.now()}`
  try {
