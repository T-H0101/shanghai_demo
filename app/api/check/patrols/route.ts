/**
 * GET/POST/PUT/DELETE /api/check/patrols
 *
 * Sprint R.83.3 Task 5 — check patrol family CRUD over center DB
 * unified_check_patrol_strategies (primary table; lists 4 unified_check_patrol_*
...
export async function GET(req: NextRequest) {
  const traceId = `rbac-patrols-${Date.now()}`
  try {
