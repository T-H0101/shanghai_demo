/**
 * Sprint R.83.3 Task 5 — 2 CRUD endpoints self-check
 *
 * Exercises GET/POST/PUT/DELETE across 2 check resources:
 *   - inspections  (unified_check_categories)
 *   - patrols      (unified_check_patrol_strategies)
 *
 * Total checks (≥12):
 ...
 *
 * Usage:
 *   pnpm exec tsx app/api/check/__tests__/self-check.ts
 */
...
const TEST_RECORD_ID = process.env.TEST_RECORD_ID ?? "test-r83-3-selfcheck-1"
