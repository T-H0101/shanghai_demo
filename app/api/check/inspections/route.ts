/**
 * GET/POST/PUT/DELETE /api/check/inspections
 *
 * Sprint R.83.3 Task 5 — check inspection family CRUD over center DB
 * unified_check_categories (primary table; lists 11 unified_check_* tables
 * in sourceTables).
 *
...
const TARGET_TABLE = "unified_check_categories"
const SOURCE_TABLES = [
...
export async function GET(req: NextRequest) {
  const traceId = `rbac-inspections-${Date.now()}`
  try {
