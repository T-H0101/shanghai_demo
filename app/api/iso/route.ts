/**
 * GET/POST/PUT/DELETE /api/iso
 *
 * Sprint R.83.6 Task 3 — ISO file-and-task-sync family CRUD over center DB
 * unified_iso_locations (primary table; lists 3 unified_iso_* tables + unified_back_windows
 * in sourceTables).
 *
 * Tables:
...
const TARGET_TABLE = "unified_iso_locations"
const SOURCE_TABLES = [
...
export async function GET(req: NextRequest) {
  const traceId = `r83-6-iso-${Date.now()}`
  try {
