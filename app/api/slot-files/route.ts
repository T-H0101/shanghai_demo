/**
 * GET/POST/PUT/DELETE /api/slot-files
 *
 * Sprint R.83.8 Task 3 — slot file family CRUD over center DB
 * unified_slot_file_1000000 (primary table; lists 6 unified_slot_file_* tables in sourceTables).
 *
...
const TARGET_TABLE = "unified_slot_file_1000000"
const SOURCE_TABLES = [
...
export async function GET(req: NextRequest) {
  const traceId = `r838-slot-files-${Date.now()}`
  try {
