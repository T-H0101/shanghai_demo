/**
 * GET/POST/PUT/DELETE /api/transfer
 *
 * Sprint R.83.5 Task 5 — upload/download transfer family CRUD over center DB
 * unified_download_records (primary table; lists 2 unified_download_* /
 * unified_upload_* tables in sourceTables).
 *
...
const TARGET_TABLE = "unified_download_records"
const SOURCE_TABLES = [
...
export async function GET(req: NextRequest) {
  const traceId = `rbac-transfer-${Date.now()}`
  try {
