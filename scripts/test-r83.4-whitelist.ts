...
check(
  ...
  ALLOWED_PACKAGE_TABLES.length === 73,
  `actual=${ALLOWED_PACKAGE_TABLES.length} (expected 13+15+15+15+15=73)`
)
...
// 11. 健全性: 13 + 15 + 15 + 15 + 15 === 当前实际长度
check(
  'sanity: 13 original + 15 R.83.1 + 15 R.83.2 + 15 R.83.3 + 15 R.83.4 = actual length',
