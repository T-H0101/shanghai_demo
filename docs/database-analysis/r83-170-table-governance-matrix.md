...
> 维护人:R.83 Sprint 系列
> 最近更新:2026-06-27 (R.83.7 桶落地: 导入导出 + 监控 + 系统辅助族 15 张)
...
| `round` | 落地 Sprint 桶:`R.83.1` / `R.83.2` / `R.83.3` / `R.83.4` / `R.83.5` / `R.83.6` / `R.83.7` / `R.83.8` / `R.83.9` / `already` / `deferred` / `never` |
| `notes` | 简要说明 |
...
4. 表大小 < 32KB → `pg17_small`,`R.83.9+`,阻塞 `none`(业务小表,候选接入)
5. 表大小 32KB ~ 10MB → `pg17_small`,`R.83.9+`,阻塞 `none`(业务表,中等,候选)
...
| `R.83.4` | 15 | Sprint R.83.4 已落地 (存储卷 + 调度/接口 + 设备业务族 15 张) |
| `already` | 13 | R.83.1 之前的 13 张白名单 |
| `R.83.5` | 15 | Sprint R.83.5 已落地 (数据接收 + 告警 + 媒体族 15 张) |
| `R.83.6` | 15 | Sprint R.83.6 已落地 (ISO + 元数据 + 系统族 15 张) |
| `R.83.7` | 15 | Sprint R.83.7 已落地 (导入导出 + 监控 + 系统辅助族 15 张) |
| `R.83.8` | 15 | Sprint R.83.8 已落地 (任务详情 + 槽位管理族 15 张) |
| `R.83.9` | 8 | Sprint R.83.9 已落地 (备份/磁盘/下载辅助族 8 张,业务表 128 张全部接入) |
...
| 5 | tbl_back_window | 16 kB | pg17_small | unified_back_windows | none | R.83.6 | ISO + 元数据 + 系统族 (R.83.6 已落地) |
| 6 | tbl_backup_db | 32 kB | pg17_small | unified_backup_dbs | none | R.83.9 | R.83.9 收尾 (备份/磁盘/下载辅助族 8 张) |
| 7 | tbl_buffer_dir | 16 kB | pg17_small | unified_buffer_dirs | none | R.83.6 | ISO + 元数据 + 系统族 (R.83.6 已落地) |
| 8 | tbl_cd_cabinet | 16 kB | pg17_small | unified_cd_cabinets | none | R.83.6 | ISO + 元数据 + 系统族 (R.83.6 已落地) |
...
| 26 | tbl_csv_details | 16 kB | pg17_small | unified_csv_details | none | R.83.7 | 导入导出 + 监控 + 系统辅助族 (R.83.7 已落地) |
| 27 | tbl_data_classification | 64 kB | pg17_small | unified_data_classifications | none | R.83.5 | 数据接收 + 告警 + 媒体族 (R.83.5 已落地) |
| 28 | tbl_data_receive_list | 16 kB | pg17_small | unified_data_receive_lists | none | R.83.5 | 数据接收 + 告警 + 媒体族 (R.83.5 已落地) |
| 29 | tbl_data_receive_log | 16 kB | pg17_small | unified_data_receive_logs | none | R.83.5 | 数据接收 + 告警 + 媒体族 (R.83.5 已落地) |
| 30 | tbl_data_receive_tasks | 16 kB | pg17_small | unified_data_receive_tasks | none | R.83.5 | 数据接收 + 告警 + 媒体族 (R.83.5 已落地) |
...
| 34 | tbl_device_device | 16 kB | pg17_small | unified_device_device | none | R.83.4 | 存储卷 + 调度 + 设备业务族 (R.83.4 已落地) |
...
| 39 | tbl_disc_inspect | 16 kB | pg17_small | unified_disc_inspects | none | R.83.5 | 数据接收 + 告警 + 媒体族 (R.83.5 已落地) |
| 40 | tbl_disc_lib | 64 kB | pg17_small | unified_disc_lib | none | already | 既有白名单 |
| 41 | tbl_disc_print | 24 kB | pg17_small | unified_disc_prints | none | R.83.5 | 数据接收 + 告警 + 媒体族 (R.83.5 已落地) |
| 42 | tbl_disc_type | 32 kB | pg17_small | unified_disc_types | none | R.83.5 | 数据接收 + 告警 + 媒体族 (R.83.5 已落地) |
| 43 | tbl_disk_check | 16 kB | pg17_small | unified_disk_checks | none | R.83.9 | R.83.9 收尾 (备份/磁盘/下载辅助族 8 张) |
| 44 | tbl_diskfile_check | 16 kB | pg17_small | unified_diskfile_checks | none | R.83.9 | R.83.9 收尾 (备份/磁盘/下载辅助族 8 张) |
| 45 | tbl_download_details | 16 kB | pg17_small | unified_download_details | none | R.83.7 | 导入导出 + 监控 + 系统辅助族 (R.83.7 已落地) |
| 46 | tbl_download_record | 16 kB | pg17_small | unified_download_records | none | R.83.5 | 数据接收 + 告警 + 媒体族 (R.83.5 已落地) |
| 47 | tbl_drivers | 64 kB | pg17_small | unified_drivers | none | R.83.4 | 存储卷 + 调度 + 设备业务族 (R.83.4 已落地) |
| 48 | tbl_drivers_burn | 32 kB | pg17_small | unified_drivers_burn | none | R.83.4 | 存储卷 + 调度 + 设备业务族 (R.83.4 已落地) |
| 49 | tbl_early_warning | 16 kB | pg17_small | unified_early_warnings | none | R.83.5 | 数据接收 + 告警 + 媒体族 (R.83.5 已落地) |
| 50 | tbl_early_warning_feedback | 16 kB | pg17_small | unified_early_warning_feedbacks | none | R.83.5 | 数据接收 + 告警 + 媒体族 (R.83.5 已落地) |
| 51 | tbl_error_rate | 16 kB | pg17_small | unified_error_rates | none | R.83.7 | 导入导出 + 监控 + 系统辅助族 (R.83.7 已落地) |
| 52 | tbl_escape | 16 kB | pg17_small | unified_escapes | none | R.83.7 | 导入导出 + 监控 + 系统辅助族 (R.83.7 已落地) |
| 53 | tbl_evidence_details | 16 kB | pg17_small | unified_evidence_details | none | R.83.5 | 数据接收 + 告警 + 媒体族 (R.83.5 已落地) |
| 54 | tbl_evidence_record_drp | 16 kB | pg17_small | unified_evidence_record_drps | none | R.83.5 | 数据接收 + 告警 + 媒体族 (R.83.5 已落地) |
| 55 | tbl_export_info | 16 kB | pg17_small | unified_export_infos | none | R.83.7 | 导入导出 + 监控 + 系统辅助族 (R.83.7 已落地) |
...
| 80 | tbl_film_operat | 16 kB | pg17_small | unified_film_operats | none | R.83.6 | ISO + 元数据 + 系统族 (R.83.6 已落地) |
...
| 86 | tbl_ft_file | 24 kB | pg17_small | unified_ft_files | none | R.83.6 | ISO + 元数据 + 系统族 (R.83.6 已落地) |
| 87 | tbl_ft_sys | 88 kB | pg17_small | unified_ft_systems | none | R.83.6 | ISO + 元数据 + 系统族 (R.83.6 已落地) |
...
| 90 | tbl_hd_manager | 32 kB | pg17_small | unified_hd_manager | none | R.83.4 | 存储卷 + 调度 + 设备业务族 (R.83.4 已落地) |
| 91 | tbl_hd_power | 16 kB | pg17_small | unified_hd_powers | none | R.83.9 | R.83.9 收尾 (备份/磁盘/下载辅助族 8 张) |
| 92 | tbl_hot_backup_record | 16 kB | pg17_small | unified_hot_backup_record | none | R.83.4 | 存储卷 + 调度 + 设备业务族 (R.83.4 已落地) |
| 93 | tbl_hot_restore_record | 16 kB | pg17_small | unified_hot_restore_record | none | R.83.4 | 存储卷 + 调度 + 设备业务族 (R.83.4 已落地) |
| 94 | tbl_import_folder_data | 8192 bytes | pg17_small | unified_import_folder_datas | none | R.83.7 | 导入导出 + 监控 + 系统辅助族 (R.83.7 已落地) |
| 95 | tbl_import_folder_log | 16 kB | pg17_small | unified_import_folder_logs | none | R.83.7 | 导入导出 + 监控 + 系统辅助族 (R.83.7 已落地) |
| 96 | tbl_import_folder_title | 16 kB | pg17_small | unified_import_folder_titles | none | R.83.7 | 导入导出 + 监控 + 系统辅助族 (R.83.7 已落地) |
| 97 | tbl_interface_task | 24 kB | pg17_small | unified_interface_task | none | R.83.4 | 存储卷 + 调度 + 设备业务族 (R.83.4 已落地) |
| 98 | tbl_iso_location | 16 kB | pg17_small | unified_iso_locations | none | R.83.6 | ISO + 元数据 + 系统族 (R.83.6 已落地) |
| 99 | tbl_iso_task_sync | 8192 bytes | pg17_small | unified_iso_task_syncs | none | R.83.6 | ISO + 元数据 + 系统族 (R.83.6 已落地) |
| 100 | tbl_lib_group | 16 kB | pg17_small | unified_lib_groups | none | R.83.6 | ISO + 元数据 + 系统族 (R.83.6 已落地) |
...
| 104 | tbl_meta_data | 16 kB | pg17_small | unified_meta_datas | none | R.83.6 | ISO + 元数据 + 系统族 (R.83.6 已落地) |
| 105 | tbl_monitor_path | 32 kB | pg17_small | unified_monitor_paths | none | R.83.7 | 导入导出 + 监控 + 系统辅助族 (R.83.7 已落地) |
| 106 | tbl_mount_dir | 16 kB | pg17_small | unified_mount_dirs | none | R.83.6 | ISO + 元数据 + 系统族 (R.83.6 已落地) |
| 107 | tbl_platform | 16 kB | pg17_small | unified_platform | none | already | 既有白名单 |
| 108 | tbl_platform_monitor | 16 kB | pg17_small | unified_platform_monitors | none | R.83.7 | 导入导出 + 监控 + 系统辅助族 (R.83.7 已落地) |
...
| 111 | tbl_project_monitor_files | 24 kB | pg17_small | unified_project_monitor_files | none | R.83.7 | 导入导出 + 监控 + 系统辅助族 (R.83.7 已落地) |
| 112 | tbl_project_site | 16 kB | pg17_small | unified_project_site | none | R.83.1 | 部门/项目/接收单 (R.83.1 已落地) |
| 113 | tbl_raid_group | 16 kB | pg17_small | unified_raid_group | none | R.83.4 | 存储卷 + 调度 + 设备业务族 (R.83.4 已落地) |
...
| 117 | tbl_receipt_file_detail | 24 kB | pg17_small | unified_receipt_file_details | none | R.83.9 | R.83.9 收尾 (备份/磁盘/下载辅助族 8 张) |
| 118 | tbl_register_management | 16 kB | pg17_small | unified_register_management | none | R.83.4 | 存储卷 + 调度 + 设备业务族 (R.83.4 已落地) |
| 119 | tbl_remote_backup | 32 kB | pg17_small | unified_remote_backups | none | R.83.7 | 导入导出 + 监控 + 系统辅助族 (R.83.7 已落地) |
...
| 122 | tbl_schedule_job | 16 kB | pg17_small | unified_schedule_job | none | R.83.4 | 存储卷 + 调度 + 设备业务族 (R.83.4 已落地) |
| 123 | tbl_site | 16 kB | pg17_small | unified_site | none | already | 既有白名单 |
| 124 | tbl_site_monitor | 16 kB | pg17_small | unified_site_monitors | none | R.83.7 | 导入导出 + 监控 + 系统辅助族 (R.83.7 已落地) |
| 125 | tbl_slot_file_1000000 | 504 kB | pg17_small | unified_slot_file_1000000 | none | R.83.8 | 任务详情 + 槽位管理族 (R.83.8 已落地) |
| 126 | tbl_slot_file_12 | 1992 kB | pg17_small | unified_slot_file_12 | none | R.83.8 | 任务详情 + 槽位管理族 (R.83.8 已落地) |
| 127 | tbl_slot_file_13 | 3392 kB | pg17_small | unified_slot_file_13 | none | R.83.8 | 任务详情 + 槽位管理族 (R.83.8 已落地) |
| 128 | tbl_slot_file_15 | 80 kB | pg17_small | unified_slot_file_15 | none | R.83.8 | 任务详情 + 槽位管理族 (R.83.8 已落地) |
| 129 | tbl_slot_file_30 | 4768 kB | pg17_small | unified_slot_file_30 | none | R.83.8 | 任务详情 + 槽位管理族 (R.83.8 已落地) |
| 130 | tbl_slot_file_31 | 1552 kB | pg17_small | unified_slot_file_31 | none | R.83.8 | 任务详情 + 槽位管理族 (R.83.8 已落地) |
| 131 | tbl_slot_folder_1000000 | 96 kB | pg17_small | unified_slot_folder_1000000 | none | R.83.8 | 任务详情 + 槽位管理族 (R.83.8 已落地) |
| 132 | tbl_slot_folder_12 | 336 kB | pg17_small | unified_slot_folder_12 | none | R.83.8 | 任务详情 + 槽位管理族 (R.83.8 已落地) |
| 133 | tbl_slot_folder_13 | 320 kB | pg17_small | unified_slot_folder_13 | none | R.83.8 | 任务详情 + 槽位管理族 (R.83.8 已落地) |
| 134 | tbl_slot_folder_15 | 48 kB | pg17_small | unified_slot_folder_15 | none | R.83.8 | 任务详情 + 槽位管理族 (R.83.8 已落地) |
| 135 | tbl_slot_folder_30 | 368 kB | pg17_small | unified_slot_folder_30 | none | R.83.8 | 任务详情 + 槽位管理族 (R.83.8 已落地) |
| 136 | tbl_slot_folder_31 | 152 kB | pg17_small | unified_slot_folder_31 | none | R.83.8 | 任务详情 + 槽位管理族 (R.83.8 已落地) |
| 137 | tbl_slots | 104 kB | pg17_small | unified_slots | none | already | 既有白名单 |
| 138 | tbl_slots_part | 32 kB | pg17_small | unified_slots_parts | none | R.83.9 | R.83.9 收尾 (备份/磁盘/下载辅助族 8 张) |
| 139 | tbl_sys | 16 kB | pg17_small | unified_sys_configs | none | R.83.6 | ISO + 元数据 + 系统族 (R.83.6 已落地) |
| 140 | tbl_sys_env | 16 kB | pg17_small | unified_sys_envs | none | R.83.6 | ISO + 元数据 + 系统族 (R.83.6 已落地) |
...
| 143 | tbl_task_certif_status | 16 kB | pg17_small | unified_task_certif_statuses | none | R.83.8 | 任务详情 + 槽位管理族 (R.83.8 已落地) |
...
| 146 | tbl_task_folder | 32 kB | pg17_small | unified_task_folders | none | R.83.7 | 导入导出 + 监控 + 系统辅助族 (R.83.7 已落地) |
| 147 | tbl_task_items | 48 kB | pg17_small | unified_task_items | none | R.83.8 | 任务详情 + 槽位管理族 (R.83.8 已落地) |
| 148 | tbl_task_print | 24 kB | pg17_small | unified_task_prints | none | R.83.8 | 任务详情 + 槽位管理族 (R.83.8 已落地) |
...
| 151 | tbl_temp_slots | 24 kB | pg17_small | unified_temp_slots | none | R.83.6 | ISO + 元数据 + 系统族 (R.83.6 已落地) |
| 152 | tbl_upload_details | 16 kB | pg17_small | unified_upload_details | none | R.83.7 | 导入导出 + 监控 + 系统辅助族 (R.83.7 已落地) |
| 153 | tbl_upload_record | 16 kB | pg17_small | unified_upload_records | none | R.83.5 | 数据接收 + 告警 + 媒体族 (R.83.5 已落地) |
...
| 158 | tbl_verify_details | 16 kB | pg17_small | unified_verify_details | none | R.83.5 | 数据接收 + 告警 + 媒体族 (R.83.5 已落地) |
| 159 | tbl_verify_record_drp | 16 kB | pg17_small | unified_verify_record_drps | none | R.83.5 | 数据接收 + 告警 + 媒体族 (R.83.5 已落地) |
| 160 | tbl_volume_dataclass | 8192 bytes | pg17_small | unified_volume_dataclass | none | R.83.4 | 存储卷 + 调度 + 设备业务族 (R.83.4 已落地) |
| 161 | tbl_volume_depa | 8192 bytes | pg17_small | unified_volume_depa | none | R.83.4 | 存储卷 + 调度 + 设备业务族 (R.83.4 已落地) |
| 162 | tbl_volume_group | 16 kB | pg17_small | unified_volume_group | none | R.83.4 | 存储卷 + 调度 + 设备业务族 (R.83.4 已落地) |
| 163 | tbl_volume_slot | 64 kB | pg17_small | unified_volume_slot | none | already | 既有白名单 |
| 164 | tbl_volume_user | 24 kB | pg17_small | unified_volume_user | none | R.83.4 | 存储卷 + 调度 + 设备业务族 (R.83.4 已落地) |
| 165 | tbl_volume_workspace | 8192 bytes | pg17_small | unified_volume_workspace | none | R.83.4 | 存储卷 + 调度 + 设备业务族 (R.83.4 已落地) |
| 166 | tbl_wait_download_file | 16 kB | pg17_small | unified_wait_download_files | none | R.83.9 | R.83.9 收尾 (备份/磁盘/下载辅助族 8 张) |
| 167 | tbl_wait_download_file_task | 8192 bytes | pg17_small | unified_wait_download_file_tasks | none | R.83.9 | R.83.9 收尾 (备份/磁盘/下载辅助族 8 张) |
...
| 170 | tbl_zip_file | 16 kB | pg17_small | unified_zip_files | none | R.83.6 | ISO + 元数据 + 系统族 (R.83.6 已落地) |
