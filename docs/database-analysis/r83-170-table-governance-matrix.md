...
| `round` | 落地 Sprint 桶:`R.83.1` / `already` / `R.83.2+` / `deferred` / `never` |
| `notes` | 简要说明 |
...
4. 表大小 < 32KB → `pg17_small`,`R.83.2+`,阻塞 `none`(业务小表,候选接入)
5. 表大小 32KB ~ 10MB → `pg17_small`,`R.83.2+`,阻塞 `none`(业务表,中等,候选)
...
| 8 | tbl_cd_cabinet | 16 kB | pg17_small | unified_cd_cabinet | none | R.83.2+ | 业务小表 (候选接入) |
| 9 | tbl_check_category | 16 kB | pg17_small | unified_check_category | none | R.83.2+ | 业务小表 (候选接入) |
| 10 | tbl_check_file | 24 kB | pg17_small | unified_check_file | none | R.83.2+ | 业务小表 (候选接入) |
| 11 | tbl_check_files | 16 kB | pg17_small | unified_check_files | none | R.83.2+ | 业务小表 (候选接入) |
| 12 | tbl_check_item | 16 kB | pg17_small | unified_check_item | none | R.83.2+ | 业务小表 (候选接入) |
| 13 | tbl_check_log | 32 kB | pg17_small | unified_check_log | none | R.83.2+ | 业务表 (中等,候选) |
| 14 | tbl_check_patrol_log | 24 kB | pg17_small | unified_check_patrol_log | none | R.83.2+ | 业务小表 (候选接入) |
| 15 | tbl_check_patrol_strategy | 16 kB | pg17_small | unified_check_patrol_strategy | none | R.83.2+ | 业务小表 (候选接入) |
| 16 | tbl_check_patrol_task | 16 kB | pg17_small | unified_check_patrol_task | none | R.83.2+ | 业务小表 (候选接入) |
| 17 | tbl_check_patrol_task_item | 24 kB | pg17_small | unified_check_patrol_task_item | none | R.83.2+ | 业务小表 (候选接入) |
| 18 | tbl_check_sector | 16 kB | pg17_small | unified_check_sector | none | R.83.2+ | 业务小表 (候选接入) |
| 19 | tbl_check_sub_category | 16 kB | pg17_small | unified_check_sub_category | none | R.83.2+ | 业务小表 (候选接入) |
| 20 | tbl_check_task | 16 kB | pg17_small | unified_check_task | none | R.83.2+ | 业务小表 (候选接入) |
...
| 29 | tbl_data_receive_log | 16 kB | pg17_small | unified_data_receive_log | none | R.83.2+ | 业务小表 (候选接入) |
| 30 | tbl_data_receive_tasks | 16 kB | pg17_small | unified_data_receive_tasks | none | R.83.2+ | 业务小表 (候选接入) |
...
| 41 | tbl_disc_print | 24 kB | pg17_small | unified_disc_print | none | R.83.2+ | 业务小表 (候选接入) |
| 42 | tbl_disc_type | 32 kB | pg17_small | unified_disc_type | none | R.83.2+ | 业务表 (中等,候选) |
| 43 | tbl_disk_check | 16 kB | pg17_small | unified_disk_check | none | R.83.2+ | 业务小表 (候选接入) |
| 44 | tbl_diskfile_check | 16 kB | pg17_small | unified_diskfile_check | none | R.83.2+ | 业务小表 (候选接入) |
| 45 | tbl_download_details | 16 kB | pg17_small | unified_download_details | none | R.83.2+ | 业务小表 (候选接入) |
| 46 | tbl_download_record | 16 kB | pg17_small | unified_download_record | none | R.83.2+ | 业务小表 (候选接入) |
| 47 | tbl_drivers | 64 kB | pg17_small | unified_drivers | none | R.83.2+ | 业务表 (中等,候选) |
| 48 | tbl_drivers_burn | 32 kB | pg17_small | unified_drivers_burn | none | R.83.2+ | 业务表 (中等,候选) |
| 49 | tbl_early_warning | 16 kB | pg17_small | unified_early_warning | none | R.83.2+ | 业务小表 (候选接入) |
| 50 | tbl_early_warning_feedback | 16 kB | pg17_small | unified_early_warning_feedback | none | R.83.2+ | 业务小表 (候选接入) |
| 51 | tbl_error_rate | 16 kB | pg17_small | unified_error_rate | none | R.83.2+ | 业务小表 (候选接入) |
| 52 | tbl_escape | 16 kB | pg17_small | unified_escape | none | R.83.2+ | 业务小表 (候选接入) |
| 53 | tbl_evidence_details | 16 kB | pg17_small | unified_evidence_details | none | R.83.2+ | 业务小表 (候选接入) |
| 54 | tbl_evidence_record_drp | 16 kB | pg17_small | unified_evidence_record_drp | none | R.83.2+ | 业务小表 (候选接入) |
| 55 | tbl_export_info | 16 kB | pg17_small | unified_export_info | none | R.83.2+ | 业务小表 (候选接入) |
...
| 80 | tbl_film_operat | 16 kB | pg17_small | unified_film_operat | none | R.83.2+ | 业务小表 (候选接入) |
...
| 92 | tbl_hot_backup_record | 16 kB | pg17_small | unified_hot_backup_record | none | R.83.2+ | 业务小表 (候选接入) |
| 93 | tbl_hot_restore_record | 16 kB | pg17_small | unified_hot_restore_record | none | R.83.2+ | 业务小表 (候选接入) |
| 94 | tbl_import_folder_data | 8192 bytes | pg17_small | unified_import_folder_data | none | R.83.2+ | 业务小表 (候选接入) |
| 95 | tbl_import_folder_log | 16 kB | pg17_small | unified_import_folder_log | none | R.83.2+ | 业务小表 (候选接入) |
| 96 | tbl_import_folder_title | 16 kB | pg17_small | unified_import_folder_title | none | R.83.2+ | 业务小表 (候选接入) |
| 97 | tbl_interface_task | 24 kB | pg17_small | unified_interface_task | none | R.83.2+ | 业务小表 (候选接入) |
| 98 | tbl_iso_location | 16 kB | pg17_small | unified_iso_location | none | R.83.2+ | 业务小表 (候选接入) |
| 99 | tbl_iso_task_sync | 8192 bytes | pg17_small | unified_iso_task_sync | none | R.83.2+ | 业务小表 (候选接入) |
| 100 | tbl_lib_group | 16 kB | pg17_small | unified_lib_group | none | R.83.2+ | 业务小表 (候选接入) |
...
| 104 | tbl_meta_data | 16 kB | pg17_small | unified_meta_data | none | R.83.2+ | 业务小表 (候选接入) |
| 105 | tbl_monitor_path | 32 kB | pg17_small | unified_monitor_path | none | R.83.2+ | 业务表 (中等,候选) |
...
| 113 | tbl_raid_group | 16 kB | pg17_small | unified_raid_group | none | R.83.2+ | 业务小表 (候选接入) |
...
| 125 | tbl_slot_file_1000000 | 504 kB | pg17_small | unified_slot_file_1000000 | none | R.83.2+ | 业务表 (中等,候选) |
| 126 | tbl_slot_file_12 | 1992 kB | pg17_small | unified_slot_file_12 | none | R.83.2+ | 业务表 (中等,候选) |
| 127 | tbl_slot_file_13 | 3392 kB | pg17_small | unified_slot_file_13 | none | R.83.2+ | 业务表 (中等,候选) |
| 128 | tbl_slot_file_15 | 80 kB | pg17_small | unified_slot_file_15 | none | R.83.2+ | 业务表 (中等,候选) |
| 129 | tbl_slot_file_30 | 4768 kB | pg17_small | unified_slot_file_30 | none | R.83.2+ | 业务表 (中等,候选) |
| 130 | tbl_slot_file_31 | 1552 kB | pg17_small | unified_slot_file_31 | none | R.83.2+ | 业务表 (中等,候选) |
| 131 | tbl_slot_folder_1000000 | 96 kB | pg17_small | unified_slot_folder_1000000 | none | R.83.2+ | 业务表 (中等,候选) |
| 132 | tbl_slot_folder_12 | 336 kB | pg17_small | unified_slot_folder_12 | none | R.83.2+ | 业务表 (中等,候选) |
| 133 | tbl_slot_folder_13 | 320 kB | pg17_small | unified_slot_folder_13 | none | R.83.2+ | 业务表 (中等,候选) |
| 134 | tbl_slot_folder_15 | 48 kB | pg17_small | unified_slot_folder_15 | none | R.83.2+ | 业务表 (中等,候选) |
| 135 | tbl_slot_folder_30 | 368 kB | pg17_small | unified_slot_folder_30 | none | R.83.2+ | 业务表 (中等,候选) |
| 136 | tbl_slot_folder_31 | 152 kB | pg17_small | unified_slot_folder_31 | none | R.83.2+ | 业务表 (中等,候选) |
...
| 146 | tbl_task_folder | 32 kB | pg17_small | unified_task_folder | none | R.83.2+ | 业务表 (中等,候选) |
| 147 | tbl_task_items | 48 kB | pg17_small | unified_task_items | none | R.83.2+ | 业务表 (中等,候选) |
| 148 | tbl_task_print | 24 kB | pg17_small | unified_task_print | none | R.83.2+ | 业务小表 (候选接入) |
...
| 151 | tbl_temp_slots | 24 kB | pg17_small | unified_temp_slots | none | R.83.2+ | 业务小表 (候选接入) |
...
| 159 | tbl_verify_record_drp | 16 kB | pg17_small | unified_verify_record_drp | none | R.83.2+ | 业务小表 (候选接入) |
| 160 | tbl_volume_dataclass | 8192 bytes | pg17_small | unified_volume_dataclass | none | R.83.2+ | 业务小表 (候选接入) |
| 161 | tbl_volume_depa | 8192 bytes | pg17_small | unified_volume_depa | none | R.83.2+ | 业务小表 (候选接入) |
| 162 | tbl_volume_group | 16 kB | pg17_small | unified_volume_group | none | R.83.2+ | 业务小表 (候选接入) |
| 163 | tbl_volume_slot | 64 kB | pg17_small | unified_volume_slot | none | already | 既有白名单 |
| 164 | tbl_volume_user | 24 kB | pg17_small | unified_volume_user | none | R.83.2+ | 业务小表 (候选接入) |
| 165 | tbl_volume_workspace | 8192 bytes | pg17_small | unified_volume_workspace | none | R.83.2+ | 业务小表 (候选接入) |
| 166 | tbl_wait_download_file | 16 kB | pg17_small | unified_wait_download_file | none | R.83.2+ | 业务小表 (候选接入) |
| 167 | tbl_wait_download_file_task | 8192 bytes | pg17_small | unified_wait_download_file_task | none | R.83.2+ | 业务小表 (候选接入) |
...
| 170 | tbl_zip_file | 16 kB | pg17_small | unified_zip_file | none | R.83.2+ | 业务小表 (候选接入) |
