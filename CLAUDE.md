...
**当前子阶段**: Sprint 0 - 方案修正完成，准备进入 Sprint 1

**架构设计**:
- 中心库: PostgreSQL，10 张 unified_* 表
- 同步: 定时任务 + 增量/快照策略，不强制 hash
- API: Node.js/Go，Sprint 1 只做 mock response
...
**参考文档**:
- 后端接入方案: `docs/database-analysis/后端接入方案-完整版.md`
- 审查报告: `docs/database-analysis/后端接入方案审查报告.md`

**Sprint 1 目标**:
- API 项目骨架 + mock response
- 不连接真实数据库
- 不替换前端 Provider
