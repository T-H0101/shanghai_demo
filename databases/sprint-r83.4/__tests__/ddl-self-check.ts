/**
 * Sprint R.83.4 — DDL Self-Check
 *
 * Verifies that the 15 unified_* business tables (storage volume / schedule /
 * device / driver family) exist in the live center DB with the required R.83.4
 * standard:
 *
 ...
 *
 * Usage:
 *   pnpm exec tsx databases/sprint-r83.4/__tests__/ddl-self-check.ts
 *
...
const EXPECTED_TABLES = [
  // First batch — should be created by 01-storage-schedule-tables.sql segment 1
