/**
 * Sprint R.83.7 — DDL Self-Check
 *
 * Verifies that the 15 unified_* business tables (import/export + monitor + system-aux family)
 * exist in the live center DB with the required R.83.7 standard:
 *
 ...
 *
 * Usage:
 *   pnpm exec tsx databases/sprint-r83.7/__tests__/ddl-self-check.ts
 *
...
const EXPECTED_TABLES = [
  // Import/export family (8) — CSV/import/upload/download/export
  "unified_csv_details",
  ...
  // System-aux family (2) — error rate + escape
  "unified_error_rates",
  "unified_escapes",
  "unified_remote_backups",
  // Monitor family (5) — monitor path/platform/site/project/task
