/**
 * Sprint R.83.9 — DDL Self-Check
 *
 * Verifies that the 8 unified_* business tables (final batch: backup/disk/hd-power/wait-download)
 * exist in the live center DB with the required R.83.9 standard:
 *
 ...
 *
 * Usage:
 *   pnpm exec tsx databases/sprint-r83.9/__tests__/ddl-self-check.ts
 *
...
const EXPECTED_TABLES = [
  // Backup/disk/hd-power family (4)
  "unified_backup_dbs",
  "unified_disk_checks",
  "unified_diskfile_checks",
  "unified_hd_powers",
  // Receipt/slots/wait-download family (4)
