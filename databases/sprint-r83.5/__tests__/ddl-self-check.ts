/**
 * Sprint R.83.5 — DDL Self-Check
 *
 * Verifies that the 15 unified_* business tables (data receive / early warning
 * / media family) exist in the live center DB with the required R.83.5
 * standard:
 *
 ...
 *
 * Usage:
 *   pnpm exec tsx databases/sprint-r83.5/__tests__/ddl-self-check.ts
 *
