/**
 * Sprint R.83.8 — DDL Self-Check
 *
 * Verifies that the 15 unified_* business tables (task detail + slot family)
 * exist in the live center DB with the required R.83.8 standard:
 *
 ...
 *
 * Usage:
 *   pnpm exec tsx databases/sprint-r83.8/__tests__/ddl-self-check.ts
 *
