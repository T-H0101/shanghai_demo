/**
 * Sprint R.83.6 — DDL Self-Check
 *
 * Verifies that the 15 unified_* business tables (ISO + meta + system family)
 * exist in the live center DB with the required R.83.6 standard:
 *
 ...
 *
 * Usage:
 *   pnpm exec tsx databases/sprint-r83.6/__tests__/ddl-self-check.ts
 *
...
const EXPECTED_TABLES = [
  // ISO + file-ops family (3) — unified_iso_*
  "unified_iso_locations",
  "unified_iso_task_syncs",
  "unified_back_windows",
  // Meta + system family (4) — unified_sys_* + unified_meta_* + unified_lib_*
  "unified_sys_configs",
  "unified_sys_envs",
  "unified_meta_datas",
  "unified_lib_groups",
  // File-ops family (8) — mount/buffer/CD/film/ft/zip/temp
  "unified_mount_dirs",
  "unified_buffer_dirs",
  "unified_cd_cabinets",
  "unified_film_operats",
  "unified_ft_files",
  "unified_ft_systems",
  "unified_zip_files",
  "unified_temp_slots",
